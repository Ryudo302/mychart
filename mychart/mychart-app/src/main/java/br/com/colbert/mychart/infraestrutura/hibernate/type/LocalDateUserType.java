package br.com.colbert.mychart.infraestrutura.hibernate.type;
...
/**
 * Implementação de {@link UserType} que informa ao Hibernate como tratar dados do tipo {@link LocalDate}.
 * 
 * @author Thiago Colbert
 * @since 16/12/2014
 * @see <a href="http://blog.progs.be/550/java-time-hibernate">Using java.time.LocalDateTime, LocalDate and LocalTime in
 *      Hibernate</a>
 */
public class LocalDateUserType implements EnhancedUserType, Serializable {

	private static final long serialVersionUID = 3816736611512027723L;
